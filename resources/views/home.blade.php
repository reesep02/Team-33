...
<header id="header">
    ...
    <img src="images/JWZ_Logo.png" style="width:50px;height:50px;">
    <h1>JEWELZ</h1>
    <div class="user-details ">
        <span><img src="images/user.png" ></span>
        <span><img src="images/cart.png" ></i></span>
    </div>
    <nav id="nav-bar ">
        <ul>
...
<main>
    ...
    <div id="section1">
        <img src="images/pexels-milan-4639591.jpg" alt="express">
    </div>

    <div class="section two">
        <button>
        <i class="gender"></i>
        <img src="images/pexels-milan-4639591.jpg" alt="genders">
        <h1>HIM</h1>
      </button>
        <button>
        <i class="gender"></i>
    ...
    <div id="section3">
        <img src="images/pexels-goran-vrakela-230290.jpg" alt="ring">
    </div>
    ...
    <div class="section four" id="necklaces">
        ...
        <p class="t3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
            irure dolor.</p>
        <p class="t4"><a href=#>BROWSE</a></p>
    </div>
    <div id='section4'>
        <img src="images/pexels-lalesh-aldarwish-147637.jpg" alt="necklace">
    </div>
    ...
    <div id='section5'>
        <img src="images/pexels-hassan-ouajbir-678327.jpg" alt="bracelet">
    </div>
    ...
    <div id='section6'>
        <img src="images/pexels-joão-rabelo-10218611.jpg" alt="earring">
    </div>
