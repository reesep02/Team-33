                    ...
                    <aside class="col-lg-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                <a href="{{ url('/') }}" class="btn-sec  btn-out  btn-main mt-2" data-abc="true">Continue Shopping</a>
                            </div>
                        </div>
                    </aside>
                    <aside class="col-lg-9">
